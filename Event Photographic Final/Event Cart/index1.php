...
<ul class = "menu"> 
 ...
 <li class = "menu"> <b> <a href = "signup.php"> Signup </a> </b> </li>
  <li class = "menu"> <b> <a href = "aboutus.php"> About Us </a> </b> </li> </ul> 
...
<center><h2><b><i>Login Form</i></b></h2></center>
<center>
<form action="index.php" method="post">
 
  <div class="container">
    <label for="txt_username"><b>Username</b></label>
    <input type="text" placeholder="Enter Username" name="txt_fname" required>
<br>
